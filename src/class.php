...
class db
{
    ...
    public function select(string $select, string $db, $where = 'None', string $other = null)
    {
        global $pdo;
        $a = null;
        $answer = [];
    ...
    public function deleted(string $table, $where = 'None', string $other = null)
    {
        global $pdo;
        $a = null;
        if (isset($other) && !empty($other)) {
    ...
    public function update(string $db, $update, $where = 'None', string $other = null)
    {
        global $pdo;
        $answer = [];
        $a = null;
    ...
    public function like(string $select, string $table, $like, $where = null)
    {
        global $pdo;
        $a = null;
    ...
    public function unique(string $table, $column)
    {
        global $pdo;
        $a = null;
        if (gettype($column) == 'array') {
    ...
    public function primary(string $table, $column)
    {
        global $pdo;
        $a = null;
        if (gettype($column) == 'array') {
    ...
    public function drop($table, array $columns = [])
    {
        global $pdo;
        $a = null;
        $q = null;
...
$a;";
    ...
    public function autoIncrement(string $table, string $column)
    {
        global $pdo;
